...
<body>
    ...
    <form action="renameFile.php" method="post" class="renameItemForm">
        <input type="hidden" class="renameItemFormId" name="renid">
        <input type="hidden" class="renameFileName" name="renname">
    </form>
    ...
    // Rename file
    const renameItemForm = document.querySelector('.renameItemForm')
    const renameItemFormId = document.querySelector('.renameItemFormId')
    const renameFileName = document.querySelector('.renameFileName')
    ...
    modalForm.addEventListener('submit', e => {
        ...
        renameFileName.value = newParent.name;
        renameItemFormId.value = newParent.id;
        renameItemForm.submit()
    })
